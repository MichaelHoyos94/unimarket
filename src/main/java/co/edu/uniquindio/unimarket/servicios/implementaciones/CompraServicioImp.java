...
public class CompraServicioImp implements CompraServicio {
    ...
    private final List<DetalleCompraGetDTO> detalleCompraGetDTOList = new ArrayList<>();
    ...
    private double obtenerPrecioCompra (List<DetalleCompraDTO> detalleCompra){
        double total = 0;
        return total;
    }
    private Compra convertirDTO (CompraDTO compraDTO) throws Exception{
        ...
        compra.setPrecio(0);
        compra.setDetalle(detalleCompraList);
        return compra;
    }
